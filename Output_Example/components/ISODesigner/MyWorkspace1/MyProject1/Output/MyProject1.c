...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(SoftKey_Q4), TYPEID_SOFTKEY, COLOR(63), 1, 1, 0, 
		XYREF(CylinderIn_20002, 0, 0),
	ID(CylinderOut64_20000), TYPEID_OUTPICT, WORD(64), WORD(64), WORD(64), 
	...
	ID(CylinderIn64_20001), TYPEID_OUTPICT, WORD(64), WORD(64), WORD(64), 
		0, 1, COLOR_WHITE, LONG(512UL), 0, 
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
	...
	ID(AuxFunction2_Q1), TYPEID_AUXFUNC2, COLOR(77), 130, 1, 
		XYREF(CylinderOut64_20000, 0, 0),
	ID(AuxFunction2_Q2), TYPEID_AUXFUNC2, COLOR(77), 130, 1, 
		XYREF(CylinderIn64_20001, 0, 0),
