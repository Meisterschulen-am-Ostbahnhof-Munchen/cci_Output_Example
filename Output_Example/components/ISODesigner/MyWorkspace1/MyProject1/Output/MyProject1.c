...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(SoftKey_Q3), TYPEID_SOFTKEY, COLOR(62), 1, 1, 0, 
		XYREF(CylinderOut_20000, 0, 0),
	ID(SoftKey_Q4), TYPEID_SOFTKEY, COLOR(62), 1, 1, 0, 
		XYREF(CylinderIn_20001, 0, 0),
	...
	ID(AuxFunction2_Q1), TYPEID_AUXFUNC2, COLOR(77), 130, 0, 
	ID(AuxFunction2_Q2), TYPEID_AUXFUNC2, COLOR(77), 130, 0, 
	ID(AuxFunction2_Q3), TYPEID_AUXFUNC2, COLOR(62), 130, 0, 
	ID(AuxFunction2_Q4), TYPEID_AUXFUNC2, COLOR(62), 130, 0, 
}; // isoOP_MyProject1
