...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(249), 1, ID(DataMask_Main), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_Main), TYPEID_DATAMASK, COLOR_WHITE, ID(SoftKeyMask_Main), 4, 0, 
		XYREF(Rectangle_SENSOR_SMALL, 180, 108),
		XYREF(Line_13000, 216, 234),
		XYREF(Rectangle_SENSOR_SMALL, 180, 198),
		XYREF(Rectangle_14000, 342, 54),
	...
	ID(Rectangle_14000), TYPEID_OUTRECT, ID(LineAttributes_24001), 
		WORD(90), WORD(72), 0, ID(FillAttributes_HRDarkGrey), 0, 
	ID(Rectangle_SENSOR_SMALL), TYPEID_OUTRECT, ID(LineAttributes_24000), 
		WORD(126), WORD(72), 0, ID(FillAttributes_HRDarkGrey), 0, 
	...
	ID(CylinderIn_20001), TYPEID_OUTPICT, WORD(80), WORD(80), WORD(80), 
		...
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
	ID(LineAttributes_24000), TYPEID_LINEATTR, COLOR(197), 1, WORD(0), 0, 
	ID(LineAttributes_24001), TYPEID_LINEATTR, COLOR_BLACK, 2, WORD(0), 0, 
