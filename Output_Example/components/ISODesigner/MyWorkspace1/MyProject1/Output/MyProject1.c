...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(SoftKeyMask_Main), TYPEID_SKEYMASK, COLOR_SILVER, 12, 0, 
		...
		REF(SoftKey_Q1),
		REF(SoftKey_Q2),
		REF(ObjectPointer_27007),
		REF(SoftKey_Q3),
		REF(SoftKey_Q4),
		REF(ObjectPointer_27000),
		REF(ObjectPointer_27002),
		REF(ObjectPointer_27003),
		REF(ObjectPointer_27004),
		REF(ObjectPointer_27005),
		REF(ObjectPointer_27006),
	ID(SoftKey_Q1), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(CylinderOut_20000, 0, 0),
	ID(SoftKey_Q2), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(CylinderIn_20001, 0, 0),
	ID(SoftKey_Q3), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(CylinderOut_20000, 0, 0),
	ID(SoftKey_Q4), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(CylinderIn_20001, 0, 0),
	...
	ID(ObjectPointer_27003), TYPEID_OBJPTR, ID(ID_NULL), 
	ID(ObjectPointer_27004), TYPEID_OBJPTR, ID(ID_NULL), 
	ID(ObjectPointer_27005), TYPEID_OBJPTR, ID(ID_NULL), 
	ID(ObjectPointer_27006), TYPEID_OBJPTR, ID(ID_NULL), 
	ID(ObjectPointer_27007), TYPEID_OBJPTR, ID(ID_NULL), 
